...
- `vault/` in the template must stay a clean generic scaffold. Real user data, skills, or empire notes never go here.
...
- Update `ECE-MULTI-VECTOR-UPGRADE.md` (or equivalent) for any retrieval or hardware changes.
